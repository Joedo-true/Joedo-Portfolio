 ...
 *
 * Внешний куб (12 рёбер) + внутренний, той же ориентации и смещённый к одной
 * из вершин внешнего (12 рёбер) + 8 соединительных рёбер вершина-в-вершину.
 * Итого 32 ребра — трубы одинаковой толщины, а не wireframe-линии.
 *
...
export function buildTesseract(outerHalf = 1, innerHalf = 0.46, shift = 0.2): TesseractShape {
